...
public class JsfUtil {
     ...
     * @param parameters Enumerator de objetos, em pares, como chave/valor dos
     *                   parametros da url
     */
    public static void prettyRedirect(String idPretty, Object... parameters) {
        ...
        try {
            ...
            Messages.addGlobalError("Problemas no redirecionamento: " + ex.getMessage());
        }
    }
